...
Ekko Proxy aka Echo Proxy is a Web Service Proxy stub server and service virtualization tool to monitor, record and playback web services.
...
* Stub APIs by creating mocks with the Ekko Proxy WireMock Editor.
* Record and playback requests and responses.
...
Ekko Proxy provides you with benefits such as:
...
```bash
java -jar ekkoproxy-1.3.jar -server.port=8080
```
